    <div id="modulo1">
        ...
        <div id="menu">
             <ul>
               <li onclick="location.href='seller.php';"><img src="images/vendedores.png"/>Vendedores</li>
               <li onclick="location.href='client.php';"><img src="images/vendedores.png"/>Clientes</li>
