...
<body>
	...
	<div id="modulo3-contenido">
		...
		<table id="dg" rownumbers="true" toolbar="#toolbar" singleSelect="true">
			<thead>
				<tr>
				...
				<form id="fm" method="post" novalidate>
					<div id="form-container">
						...
						<div class="fitem">
			   			...
			   			<div class="fitem">
							<label>Estado:</label>
							<select id="status" name="status" class="easyui-combobox" editable="false" data-options="valueField:'value',textField:'text'" style="width: 121.533px;"></select>
						</div>
						<div class="fitem">
